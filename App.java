public class App {
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        System.out.println("The greater value between 49 and 76 is " + greaterValue(49,76));

        /**
         * Call the greaterValue method with double parameters
         */
        System.out.println("The greater value between 1.3 and 4.6 is " + greaterValue(1.3,4.6));
